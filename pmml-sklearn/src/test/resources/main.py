...
if "Audit" in datasets:
	...
	build_audit(audit_df, CalibratedClassifierCV(LinearSVC(dual = False, random_state = 13), ensemble = False, method = "isotonic"), "LinearSVCIsotonicAudit")
	...
	build_audit(audit_df, CalibratedClassifierCV(RidgeClassifier(), ensemble = False, method = "sigmoid"), "RidgeSigmoidAudit")
...
if "Iris" in datasets:
	...
	build_iris(iris_df, CalibratedClassifierCV(RidgeClassifier(), ensemble = False, method = "sigmoid"), "RidgeSigmoidIris")
	...
	build_iris(iris_df, CalibratedClassifierCV(SGDClassifier(max_iter = 100, random_state = 13), ensemble = False, method = "sigmoid"), "SGDSigmoidIris")
