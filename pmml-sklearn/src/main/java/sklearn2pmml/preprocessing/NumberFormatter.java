...
public class NumberFormatter extends Transformer {
	...
	public List<Feature> encodeFeatures(List<Feature> features, SkLearnEncoder encoder){
		...
		Apply apply = PMMLUtil.createApply(PMMLFunctions.FORMATNUMBER, feature.ref(), PMMLUtil.createConstant(pattern, DataType.STRING));
